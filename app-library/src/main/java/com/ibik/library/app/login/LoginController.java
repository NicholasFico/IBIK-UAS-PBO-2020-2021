...
public class LoginController {
	...
	private void initialize() {
		...
		labelIcon.setIcon(new ImageIcon(
				"D:\\NF\\Semester 3\\PemogramanBerorientasiObjek\\UAS\\Pemograman-Object-Oriented-master\\src\\UAS\\soal\\tujuh\\sampai\\sepuluh\\app-library\\src\\main\\java\\com\\ibik\\library\\images\\logo-ibik-web.png"));
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(callback.getResponce()) {
					frameMain.dispose();
					new ProfileController(user).setVisible(true);
				}else {
